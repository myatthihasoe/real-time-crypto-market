...
const SearchModal = ({
    ...
    useKey((event) => event.key?.toLowerCase() === 'k' && (event.metaKey || event.ctrlKey), (event) => {
        ...
        <div id="search-modal">
            ...
            <CommandDialog open={open}
                ...
                <div className="cmd-input">
                    <CommandInput placeholder="Search for a token by name or symbol..."
                                  value={searchQuery}
